const {
  ...
  addEmergencyReport,
  addDailyAssessement,
  searchEmergencyReportsViaDate,
  addCommunicableDiseaseCase,
  getAllEmergencyReports,
  getAllEmergencyReportsResolved,
  getAllEmergencyReportsByStatus,
  updateEmergencyReportCaseStatus,
  deleteEmergencyReportCase,
  getAllEmergencyReportsByVictimName,
  getAllEmergencyReported,
  addReportNotificationToUser,
  addReportNotificationToClinic,
  addReportNotificationToAdmin,
} = require('./covid_case.service');
        ...
        addReportNotificationToUser(
          {
            ...
            notification_description:
              'An emergency report under patient name : ' + body.patient_name + ' has been sent successfully.',
