const {
  emailClinicAdminCheck,
  createClinicAdmin,
  getClinicAdminByEmail,
  getTotalActiveEmergencyReports,
  getTotalCommunicableDiseaseReports,
  getTotalCommunicableDiseaseReportedOngoing,
  getTotalCommunicableDiseaseReportedResolved,
  getTotalResolvedEmergencyReports,
  getTotalCommunicableDiseaseReportedTodayOngoing,
  getTotalCommunicableDiseaseReportedTodayResolved,
  updateNewPassword,
  checkIfEmailExist,
  addClinicRecoveryPassword,
  sendLinkToEmail,
  checkIfEmailAndRecoveryPasswordMatched,
  updateClinicCredentials,
  checkIfIdAndPasswordMatched,
} = require('./clinicAdmin.service');
