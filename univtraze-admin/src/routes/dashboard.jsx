  ...
  return (
    <div className="dashboard">
        ...
        <div className="card-container">
            ...
            <Card  redir={covidreport}label="Disease reports" data={allCommunicableDisease.length} type="Disease reports" design="secondary-cards card-2" icon={covid}/>
                ...
                <p className="data">
{
              ...
              <Button destination={'/admin/covid-full-details'} label="See full details"/>
            </div>
        </div>
    </div>
  )
